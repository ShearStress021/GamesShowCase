...
#
get_filename_component(filename "/home/kanja/projects/GamesShowCase/armageddonClash/build/_deps/raygui-subbuild/raygui-populate-prefix/src/3.2.tar.gz" ABSOLUTE)
get_filename_component(directory "/home/kanja/projects/GamesShowCase/armageddonClash/build/_deps/raygui-src" ABSOLUTE)
...
#
set(i 1234)
while(EXISTS "${directory}/../ex-raygui-populate${i}")
  math(EXPR i "${i} + 1")
endwhile()
set(ut_dir "${directory}/../ex-raygui-populate${i}")
